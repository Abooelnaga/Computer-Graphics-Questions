...
**Q16:** Which application area includes flight simulators, driving simulators, and surgical simulation?
...
**Q26:** Which of the following is a 2D geometric primitive?
A) Sphere
B) Polyhedron
C) Circle
D) Light source
...
**Q41:** The DDA (Digital Difference Analyzer) algorithm is used for:
A) Drawing circles
B) Drawing lines
C) Filling polygons
D) Anti-aliasing
...
**Q51:** How do you obtain a 2D rendering context from a canvas element?
...
**Q59:** Which transformation moves points by a fixed distance in a given direction?
A) Scaling
B) Rotation
C) Translation
D) Shearing
...
**Q81:** Which color model is used for computer monitors and CRT displays?
A) CMYK
B) HSV
C) RGB
D) YIQ
